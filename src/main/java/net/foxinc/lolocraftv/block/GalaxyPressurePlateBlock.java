...
public class GalaxyPressurePlateBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_pressure_plate")
	public static final Block block = null;

	public GalaxyPressurePlateBlock(LolocraftvModElements instance) {
		super(instance, 9);
	}
