...
public class GalaxyPlanksBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_planks")
	public static final Block block = null;

	public GalaxyPlanksBlock(LolocraftvModElements instance) {
		super(instance, 3);
	}
