...
public class GalaxyFenceBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_fence")
	public static final Block block = null;

	public GalaxyFenceBlock(LolocraftvModElements instance) {
		super(instance, 7);
	}
