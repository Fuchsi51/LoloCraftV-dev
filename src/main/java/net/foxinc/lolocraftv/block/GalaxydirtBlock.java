...
public class GalaxydirtBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxygrass")
	public static final Block block = null;

	public GalaxydirtBlock(LolocraftvModElements instance) {
		super(instance, 21);
	}
