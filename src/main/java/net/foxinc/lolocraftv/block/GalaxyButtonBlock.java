...
public class GalaxyButtonBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_button")
	public static final Block block = null;

	public GalaxyButtonBlock(LolocraftvModElements instance) {
		super(instance, 10);
	}
