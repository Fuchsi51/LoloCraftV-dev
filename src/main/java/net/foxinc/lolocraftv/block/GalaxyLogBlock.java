...
public class GalaxyLogBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_log")
	public static final Block block = null;

	public GalaxyLogBlock(LolocraftvModElements instance) {
		super(instance, 2);
	}
