...
public class GalaxyStairsBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_stairs")
	public static final Block block = null;

	public GalaxyStairsBlock(LolocraftvModElements instance) {
		super(instance, 5);
	}
