...
public class GalaxyWoodBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_wood")
	public static final Block block = null;

	public GalaxyWoodBlock(LolocraftvModElements instance) {
		super(instance, 1);
	}
