...
public class GalaxyLeavesBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_leaves")
	public static final Block block = null;

	public GalaxyLeavesBlock(LolocraftvModElements instance) {
		super(instance, 4);
	}
