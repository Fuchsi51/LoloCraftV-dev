...
import net.fuchsiiis.lolocraftv.procedures.MegagalaxydustbombRedstoneAnProcedure;
...
public class MegagalaxydustbombBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:megagalaxydustbomb")
	public static final Block block = null;

	public MegagalaxydustbombBlock(LolocraftvModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("megagalaxydustbomb");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				MegagalaxydustbombRedstoneAnProcedure.executeProcedure(Stream
