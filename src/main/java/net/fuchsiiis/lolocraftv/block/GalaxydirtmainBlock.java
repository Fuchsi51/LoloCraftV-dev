...
public class GalaxydirtmainBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxydirtmain")
	public static final Block block = null;

	public GalaxydirtmainBlock(LolocraftvModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("galaxydirtmain");
		}
