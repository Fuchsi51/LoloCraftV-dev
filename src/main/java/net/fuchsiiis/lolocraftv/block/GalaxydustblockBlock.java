...
import net.fuchsiiis.lolocraftv.procedures.GalaxydustPlayerFinishesUsingItemProcedure;
...
public class GalaxydustblockBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxydustblock")
	public static final Block block = null;

	public GalaxydustblockBlock(LolocraftvModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("galaxydustblock");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				GalaxydustPlayerFinishesUsingItemProcedure.executeProcedure(Stream
